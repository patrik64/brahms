      ...
      <PopoverGroup as="nav" class="hidden md:flex space-x-10">
        <Popover class="relative" let:open>
          <PopoverButton
            class="{open
              ? 'text-gray-900'
              : 'text-gray-500'} group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none"
          >
            <span>Projekte</span>
            <ChevronDownIcon
              class="{open
                ...
                >
                  {#each projects as item}
                    ...
                    >
                      <svelte:component
                        this={item.icon}
                        class="flex-shrink-0 h-6 w-6 text-teal-600"
                        aria-hidden="true"
                      />
                      <div class="ml-4">
        ...
        <div class="py-6 px-5 space-y-6">
          <div class="grid grid-cols-1 gap-y-4 gap-x-8">
            ...
            <PopoverButton
              ...
              href="/literature"
              class="text-base font-medium text-gray-900 hover:text-gray-700"
              >Literatur</PopoverButton
            >
            <PopoverButton
              as="a"
              href="/contact"
              class="text-base font-medium text-gray-900 hover:text-gray-700"
              >Kontakt</PopoverButton
            >
          </div>
        </div>
      </div>
