<div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
  <div class="max-w-7xl mx-auto text-gray-600 text-lg">
    ...
    <div class="pt-4">Krönung ihrer Wiener Karriere, welche dank ihres Engagements im Rahmen von Wohltätigkeitskonzerten auch nach ihrer Vermählung mit Baron Wolff-Stomersee nie gänzlich zum Erliegen kam, war mit Sicherheit ihr Abschiedskonzert am 21. Dezember 1893, bei dem Brahms sie am Klavier begleitete. Alice Barbi engagierte sich aber auch nach Brahms‘ Tod für dessen Musik, wovon zahlreiche Wohltätigkeitskonzerte (meist reine „Brahms-Abende“) genauso zeugen wie die Tatsache, dass sie die Erste war, die ihren Konzerterlös für die Errichtung eines Brahms-Denkmals spendete. Dieses Denkmal, das heute im Resselpark steht, ist also nicht zuletzt auch eine Erinnerung an die „große“ Alice Barbi und ihre Verehrung für Johannes Brahms.</div>
    <img class="m-auto border-solid border border-black mt-4" src="/images/iterpreters/barbi-alice.jpg" alt="barbi" />
    <div class="text-center text-xs">Alice Barbi und Brahms vor dem Hotel Imperial, 1892 &copy; ÖNB</div>

    <!--baumayer-->
    <div id="baumayer" class="py-8 text-center text-3xl">Marie Baumayer (1851-1931)</div>
    <div>
      <div class="float-left p-2 flex-1 flex-col">
        <img class="object-contain" src="/images/iterpreters/baumayer-marie.jpg" alt="baumayer" />
        <div class="text-xs">&copy; Sophie Drinker Institut</div>
      </div>
    ...
    <!--brull-->
    <div id="brull" class="py-8 text-center text-3xl">Ignaz Brüll (1846-1907)</div>
    <div>
      <div class="float-right p-2 flex-1 flex-col">
        <img class="object-contain border-solid border border-black" src="/images/iterpreters/bruell-ignaz.jpg" alt="brull" />
        <div class="text-xs">In seinem Heim Liechtensteinstr. 4, 9. Bezirk, 1892 &copy; ÖNB / Grillich</div>
      </div>
      <p>Als Zehnjähriger wurde Ignaz Brüll Schüler des berühmten Pianisten Julius Epstein, sein Debüt gab er mit 13 und bereits zwei Jahre später wurde sein 1. Klavierkonzert uraufgeführt. Ab da war Ignaz Brüll ein bekannter Name im Musikgeschehen seiner Zeit. 1872 begann er als Lehrer an der renommierten Wiener Klavierschule Horak, deren Mitdirektor er 1881 wurde. In den 1890er Jahren wandelte sich sein Repertoire; ab diesem Zeitpunkt trat er fast ausschließlich als Interpret neuer Werke von Carl Goldmark, Johannes Brahms (Uraufführung der Klavierstücke op. 76, op. 116, Nr. 1-3, op. 117, Nr. 1 und 2 sowie op. 119, Nr. 2) sowie eigener Kompositionen in Erscheinung.</p>
      <p class="py-4">Doch nicht nur Brülls pianistische Qualitäten wurden geschätzt, sondern auch und vor allem seine menschlichen. So zählten etwa Carl Goldmark, Robert Fuchs, Eusebius Mandyczewski, Eduard Hanslick, Gustav Mahler, Theodor Billroth und nicht zuletzt Johannes Brahms zu seinem großen Freundeskreis. War er für Max Kalbeck der „Brahms-Pianist par Excellence“, so urteilte dieser gar über den liebevoll „Nazi“ titulierten Freund: „Wie etwas klingt, was ich gemacht habe, weiß ich erst, wenn ich's von Brüll gehört habe.“ (Quelle: <a rel="external" href="https://kulturstiftung.org/biographien/brull-ignaz-2" class="text-teal-400">Kulturstiftung der deutschen Vertriebenen</a>)</p>
    </div>

    <!--hellmesberger-->
    <div id="hellmesberger" class="py-8 text-center text-3xl">Hellmesberger-Quartett</div>
    <div>
      <div class="float-left p-2 flex-1 flex-col">
        <img class="object-contain border-solid border border-black" src="/images/iterpreters/hellmesberger-quartett-2.jpg" alt="hellmesberger2" />
        <div class="text-xs">Im Jahr 1873: Joseph Hellmesberger senior (r. o.), Joseph Hellmesberger junior (r. u.),</div>
        <div class="text-xs">Heinrich Röver (l. o.) und Sigismund Bachrich (l. u.) &copy; Wikipedia</div>
      </div>
    ...
    <!--joachim-->
    <div id="joachim" class="py-4 text-center text-3xl">Joachim-Quartett</div>
    <img class="m-auto border-solid border border-black mt-4" src="/images/iterpreters/joachim-quartett.jpg" alt="joachim" />
    <div class="text-center text-xs">1884: Heinrich de Ahna (l.), Robert Hausmann (o.), Emanuel Wirth (r.), Joseph Joachim (u.) &copy; Wikipedia</div>
    <div class="pt-4">1869 von dem Violinvirtuosen und Brahms-Freund Joseph Joachim gegründet, wurde diese Quartettformation, die bis zu Joachims Tod 1907 bestand, zu einem der Hauptrepräsentanten deutscher Musikkultur im späten 19. und frühen 20. Jahrhundert. Die Besetzung erlebte zwar einige Wechsel, die Qualität blieb aber dank Joachims Führung stets auf unumstritten hohem Niveau.</div>
    <ul class="pl-8" style="list-style-type: circle;">
      <li class="pt-2 pl-2">1. Violine: Joseph Joachim</li>
      <li class="pt-2 pl-2">2. Violine: Ernst Schiever (1869-1872), Heinrich de Ahna (1872-1892), Johann Kruse (1892-1897), Carl Halir (1897-1907)</li>
      <li class="pt-2 pl-2">Viola: Heinrich de Ahna (1869-1872), Eduard Rappoldi (1872-1877), Emanuel Wirth (1877-1906), Karl Klingler (1906-1907)</li>
      <li class="pt-2 pl-2">Violoncello: Wilhelm Müller (1869-1879), Robert Hausmann (1879-1907)</li>
    </ul>
    <div class="pt-4">Auf Programmen des Joachim-Quartetts fehlte ein Komponist selten: Johannes Brahms. Joachim trat von Beginn an für die Werke seines Freundes ein und durfte u.a. die Streichquartette op. 51, Nr. 2 und op. 67 zur Uraufführung bringen.</div>

    <!--rose-->
    <div id="rose" class="py-8 text-center text-3xl">Rosé-Quartett</div>
    <div>
      <div class="float-right p-2 flex-1 flex-col">
      ...
      <ul class="pl-8" style="list-style-type: circle;">
        ...
        <li class="pt-2">Viola: Anton Loh (1882-1883), Sigismund Bachrich (1884-1894), Hugo von Steiner (1895-1901), Anton Ruzitska (1901-1929), Max Handl (1930-1933), Julius Stwertka (1934-1938)</li>
        <li class="pt-2">Violoncello: Eduard Rosé (1882-1883), Reinhold Hummer (1884-1900), Friedrich Buxbaum (1901-1920 und 1922-1945), Anton Walter (1921)</li>
      </ul>
