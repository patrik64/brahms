<div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
  <div class="max-w-7xl mx-auto text-gray-600 text-lg">
    ...
    <!--baumayer-->
    <div id="baumayer" class="pt-16 pb-4 text-center text-3xl">Marie Baumayer (1851-1931)</div>
    <div>
    ...
    <!--hellmesberger-->
    <div id="hellmesberger" class="pt-16 pb-4 text-center text-3xl">Hellmesberger-Quartett</div>
    <div>
      <div class="float-left p-2 flex-1 flex-col">
    ...
    <!--rose-->
    <div id="rose" class="pt-16 pb-4 text-center text-3xl">Rosé-Quartett</div>
    <div>
      <div class="float-right p-2 flex-1 flex-col">
