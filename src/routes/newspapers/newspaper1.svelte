<div class="my-10 mx-auto w-1/2 bg-white shadow overflow-hidden sm:rounded-lg">
  <div class="px-4 py-5 sm:px-6">
    <a
      rel="external"
      href="https://anno.onb.ac.at/info/aze_info.htm"
      class="text-2xl leading-6 font-medium text-teal-400">Arbeiter Zeitung</a
    >
    <img
