<div class="my-10 mx-auto w-1/2 bg-white shadow overflow-hidden sm:rounded-lg">
  <div class="px-4 py-5 sm:px-6">
    <a
      rel="external"
      href="https://anno.onb.ac.at/info/mtk_info.htm"
      class="text-2xl leading-6 font-medium text-teal-400"
      >Blätter für Musik, Theater und Kunst</a
    >
    <img
    ...
    <dl class="sm:divide-y sm:divide-gray-200">
      <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        ...
        <dd class="mt-1 text-sm text-gray-600 sm:mt-0 sm:col-span-2">
          Österreichische Wochenzeitung zum Thema Kunst
        </dd>
      </div>
      <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        <dt class="text-sm font-medium text-gray-600">Laufzeit</dt>
        <dd class="mt-1 text-sm text-gray-600 sm:mt-0 sm:col-span-2">
          1855-1873, 1. Ausgabe: 2. Februar 1855
        </dd>
      </div>
      <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
      ...
      <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        ...
        <dd class="mt-1 text-sm text-gray-600 sm:mt-0 sm:col-span-2">
          Leopold Alexander Zellner, Ludwig Oppenheimer
        </dd>
      </div>
    </dl>
  </div>
