<div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
  <div class="max-w-7xl mx-auto text-gray-600">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            <div class="text-xs font-medium lg:text-sm text-center">
              <h3>
                <a href="#ambros" class="text-teal-400">August Wilhelm Ambros</a>
              </h3>
            </div>
          </div>
        </div>
      ...
      <li>
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            <div class="text-xs font-medium lg:text-sm text-center">
              <h3>
                <a href="#bruyck" class="text-teal-400">Carl Debrois van Bruyck</a>
              </h3>
            </div>
          </div>
        </div>
    ...
    <div class="py-2 text-justify">
      Über seine Tätigkeit als Musikkritiker heißt es in dem Nachruf des <i>Neuen Wiener Abendblattes</i> vom 28. Juni 1876: „Seit seinem Aufenthalte in Wien, der mit Ende der sechziger Jahre begann, besorgte Ambros die musikalische Kiritk für die ‚Wiener Abendpost‘, die sich stets durch ein gewisses Wohlwollen für alle Produktion und Reproduktion auszeichnete.“
    </div>
