<div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
  <div class="max-w-7xl mx-auto text-gray-600">
    <div class="text-center text-3xl mb-10">Rezensenten</div>
    ...
    <ul class="mx-auto grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-4 md:gap-x-6 lg:max-w-5xl lg:gap-x-8 lg:gap-y-12 xl:grid-cols-6">
        ...
        <a href="#ambros" class="space-y-4">
          ...
          <div class="space-y-2">
            <div class="text-xs font-medium lg:text-sm text-center">
              <h3>
                <div class="text-teal-400">August Wilhelm Ambros</div>
              </h3>
            </div>
          </div>
        </a>
      ...
      <li>
        <a href="#bruyck" class="space-y-4">
          ...
          <div class="space-y-2">
            <div class="text-xs font-medium lg:text-sm text-center">
              <h3>
                <div class="text-teal-400">Carl Debrois van Bruyck</div>
              </h3>
            </div>
          </div>
        </a>
      ...
      <li>
        <a href="#frey" class="space-y-4">
          ...
          <div class="space-y-2">
            <div class="text-xs font-medium lg:text-sm text-center">
              <h3>
                <div class="text-teal-400">Wilhelm Frey</div>
              </h3>
            </div>
          </div>
        </a>
      ...
      <li>
        <a href="#gaigg" class="space-y-4">
          ...
          <div class="space-y-2">
            <div class="text-xs font-medium lg:text-sm text-center">
              <h3>
                <div class="text-teal-400">Fritz Gaigg von Bergheim</div>
              </h3>
            </div>
          </div>
        </a>
      ...
      <li>
        <a href="#gollerich" class="space-y-4">
          ...
          <div class="space-y-2">
            <div class="text-xs font-medium lg:text-sm text-center">
              <h3>
                <div class="text-teal-400">August Göllerich</div>
              </h3>
            </div>
          </div>
        </a>
      ...
      <li>
        <a href="#hirschfeld" class="space-y-4">
          ...
          <div class="space-y-2">
            <div class="text-xs font-medium lg:text-sm text-center">
              <h3>
                <div class="text-teal-400">Robert Hirschfeld</div>
              </h3>
            </div>
          </div>
        </a>
      ...
      <li>
        <a href="#horn" class="space-y-4">
          <img class="mx-auto h-20 w-20 rounded-full lg:w-24 lg:h-24 object-cover" src="/images/reviewers/thumbs/horn.png" alt="horn" />
          <div class="space-y-2">
            <div class="text-xs font-medium lg:text-sm text-center">
              <h3>
                <div class="text-teal-400">Camillo Horn</div>
              </h3>
            </div>
          </div>
        </a>
    ...
    <div id="ambros" class="pt-16 pb-4 text-center text-2xl">August Wilhelm Ambros</div>
    <div class="py-2">*17.11.1816 Mauth bei Prag, †28.06.1876 Wien</div>
    <div>
    ...
    <div class="py-2 text-justify">
      Über seine Tätigkeit als Musikkritiker heißt es in dem Nachruf des <i>Neuen Wiener Abendblattes</i> vom 28. Juni 1876: <i>„Seit seinem Aufenthalte in Wien, der mit Ende der sechziger Jahre begann, besorgte Ambros die musikalische Kiritk für die 'Wiener Abendpost', die sich stets durch ein gewisses Wohlwollen für alle Produktion und Reproduktion auszeichnete.“</i>
    </div>
    <div class="text-sm">Quelle: <a rel="external" href="https://dx.doi.org/10.1553/0x0001f6cd" class="text-teal-400" target="”_blank”">Evelyn Szabo / Elisabeth Th. Hilscher, Art. „Ambros, August Wilhelm‟</a>, in: <i>Oesterreichisches Musiklexikon online</i>, Zugriff: 6.4.2021. Nachruf, in: <a rel="external" href="https://anno.onb.ac.at/cgi-content/anno?aid=nwg&datum=18760628&seite=19&zoom=33&query=%22Ambros%22&ref=anno-search" class="text-teal-400"><i>Neues Wiener Abendblatt, Jg. 9, Nr. 176, 28.06.1876, S. 3f.</i></a>, Nachruf, in: <a rel="external" href="https://anno.onb.ac.at/cgi-content/anno?aid=wrz&datum=18760628&query=%22Ambros%22&ref=anno-search&seite=14" class="text-teal-400"><i>Wiener Abendpost, Beilage zur Wiener Zeitung, Nr. 146, 28.06.1876, S. 2</i></a>.</div>

    <!--bruyck-->
    <div id="bruyck" class="pt-16 pb-4 text-center text-2xl">Carl Debrois van Bruyck</div>
    <div class="py-2">*14.03.1828 Brünn, †02.08.1902 Waidhofen an der Ybbs/NÖ</div>
    <div>
    ...
    <!--frey-->
    <div id="frey" class="pt-16 pb-4 text-center text-2xl">Wilhelm Frey</div>
    <div class="py-2">*14.03.1828 Brünn, †02.08.1902 Waidhofen an der Ybbs/NÖ</div>
    <div>
      <div class="float-left p-2 flex-1 flex-col">
        <img class="object-contain" src="/images/reviewers/frey-wilhelm.jpg" alt="frey" />
        <div class="text-xs">&copy; Österreichs Illustrierte Zeitung</div>
        <div class="text-xs">Heft 30, 25. April 1909, S. 693.</div>
      </div>
      <p class="text-justify">Musikkritiker, Journalist und Schriftsteller, Vizepräsident des Journalisten- und Schriftstellervereines Concordia. Widmete sich zunächst der pädagogischen Laufbahn und wurde zum Professor für Mittelschulen graduiert. Zusätzlich absolvierte er zur Zeit seiner Lehrtätigkeit in Prag die Orgelschule. Während seiner Studien und seinem pädagogischen Beruf war Frey erfolgreich schriftstellerisch tätig und zählte in der zweiten Hälfte der 1850er- und ersten Hälfte der 1860er- Jahre zu den ersten deutschen Jugendschriftstellern neben den damaligen Größen Gustav Nieritz und Franz Hofmann. 1865 ging er nach Wien, wo er als Offizial in das administrative Revisionsamt der Kaiser Ferdinands-Nordbahn eintrat, dort Sekretär und Chef des Personalbureaus wurde, bevor er 1873 den Eisenbahndienst verließ und sich vollends der bis dahin nebenbei ausgeübten Journalistik widmete.</p>
      <p class="py-4 text-justify">1858-1867 Musikreferent der Morgenpost, seit der Gründung des Neuen Wiener Tagblatt (1873) „fast von den ersten Nummern an“ Musikkritiker, ab den 1890er Jahren Lokalschilderer dieses Blattes, dem er bis zu seinem Tod angehören sollte (Neues Wiener Tagblatt, 17. April 1909, S. 8). In diesem Nachruf heißt es weiters: „Seiner Liebe zum musikalisch Schönen, seiner Kenntnis des Theaters stand eine große Erfahrung zur Seite, an die Direktoren und Kapellmeister, Musiker und Sänger oft genug appellierten.“ Konkret wird Hofoperntheater-Direktor Jahn erwähnt, der „mit seinen Partituren oft genug bei Frey erschien, um dessen Gutachten einzuholen.“</p>
    </div>
    <div class="text-sm">Quelle: Elisabeth Th. Hilscher, Art. „Frey, Wilhelm‟, in: Oesterreichisches Musiklexikon online, Zugriff: 6.4.2021; Österreichs Illustrierte Zeitung, Heft 30, 25. April 1909, S. 694; Illustrierte Kronen-Zeitung, Nr. 3340, 17. April 1909, S. 8; Das Vaterland, 17. April 1909, S. 6; Arbeiter-Zeitung, 18. April 1909, S. 6; Neues Wiener Tagblatt, 17. April 1909, S. 8.</div>

    <!--gaigg-->
    <div id="gaigg" class="pt-16 pb-4 text-center text-2xl">Fritz Gaigg von Bergheim</div>
    <div class="py-2">*31.10.1848 Wien, †1918</div>
    <div class="py-2 text-justify">Musikschriftsteller, hauptberuflich Mittelschulprofessor an der Rainerschen Realschule in Wien, im Ersten Weltkrieg zusätzliche Lehrstelle an den Horakschen Musikschulen. Besonders eng ist sein Name als Musikkritiker mit der Reichspost verbunden. In einem Nachruf charakterisierte die Redaktion der Reichspost ihren verstorbenen Mitarbeiter mit den Worten:</div>
    <div class="py-2 text-justify"><i>„Als Musikschriftsteller war Friedrich Gaigg R. v. Bergheim in allen Wiener Theatern und Konzertsälen fast eine Generation hindurch zu Hause; die langjährige Erfahrung, die weit zurückreichende Personalkenntnis und seine ideale Liebe zur Musik, das waren die Charakteristiken dieses Mannes. in seinen Besprechungen spiegelte sich das wohlwollende Wesen des grundgütigen Menschen, der mit Vorliebe neu aufstrebende Talente förderte und sie mit freundlichen Worten in seinen niemals strengen Kritiken zum Aufstieg, aber auch zur Selbstzucht, zum fleißigen Studium ermunterte.“</i></div>
    <div class="py-2 text-justify">Kürzel: G. v. B.</div>
    <div class="text-sm">Quellen: Nachruf, in: Reichspost, Mittagsblatt, Jg. 25, Nr. 90, 25.02.1918, S. 3, Todesanzeige, in: Deutsches Volksblatt, Morgenausgabe, Jg. 30, Nr. 10469, 26.02.1918, S. 8.</div>

    <!--gollerich-->
    <div id="gollerich" class="pt-16 pb-4 text-center text-2xl">August Göllerich</div>
    <div class="py-2">*02.07.1859 Linz, †16.03.1923 Linz</div>
    <div>
      <div class="float-left p-2 flex-1 flex-col">
        <img class="object-contain" src="/images/reviewers/goellerich-august.jpg" alt="gollerich" />
        <div class="text-xs">&copy; Wessely: Musik in Oberösterreich, 1951</div>
      </div>
    ...
    <!--hahn-->
    <div id="hahn" class="pt-16 pb-4 text-center text-2xl">Ludwig Benedikt Hahn</div>
    <div class="py-2">*23.09.1844 Mühlhausen/Böhmen, †26.04.1923</div>
    <div>
      <div class="float-right p-2 flex-1 flex-col">
        <img class="object-contain" src="/images/reviewers/hahn-ludwig-benedikt.jpg" alt="hahn" />
        <div class="text-xs">&copy; Wikipedia</div>
      </div>
      <p class="text-justify">k. k. Hofrat und Journalist, konvertierte 1877 vom Judentum zum Katholizismus.</p>
      <p class="py-4 text-justify">Mitredakteur des <i>Neuen Fremdenblattes</i>, des <i>Fremdenblattes</i> und schließlich der <i>Wiener Zeitung</i>, bei der er zugleich das Musikreferat in der <i>Wiener Abendpost</i> führte. 1889 wurde er Vorstand des Telegraphen-Correspondenz-Bureaus und war auch Herausgeber der <i>Politischen Correspondenz</i>. Als Kritiker zeichnete Hahn mit »h«.</p>
      <p class="py-4 text-justify">Vater der Malerin und Grafikerin Louise Fraenkl-Hahn (1878-1939), des Mathematikers Hans Hahn (1879-1934) sowie der Philosophin und Mathematikerin Olga Hahn-Neurath (1882-1937).</p>
    </div>
    <div class="text-sm">Quelle: <i>Neue Freie Presse</i>, 3. Mai 1923, S. 7.</div>
    <div class="md:h-16" />

    <!--hanslick-->
    <div id="hanslick" class="pt-16 pb-4 text-center text-2xl">Eduard Hanslick</div>
    ...
    <!--hirsch-->
    <div id="hirsch" class="pt-16 pb-4 text-center text-2xl">Rudolf Hirsch</div>
    ...
    <!--kalbeck-->
    <div id="kalbeck" class="pt-16 pb-4 text-center text-2xl">Max Kalbeck</div>
    ...
    <!--kulke-->
    <div id="kulke" class="pt-16 pb-4 text-center text-2xl">Eduard Kulke</div>
    ...
    <!--Paumgartner-->
    <div id="paumgartner" class="pt-16 pb-4 text-center text-2xl">Hans Paumgartner</div>
    ...
    <!--puchstein-->
    <div id="puchstein" class="pt-16 pb-4 text-center text-2xl">Hans Puchstein</div>
    ...
    <!--schelle-->
    <div id="schelle" class="pt-16 pb-4 text-center text-2xl">Eduard Schelle</div>
    ...
    <div class="py-2 text-justify">
      ...
      Componisten“ (in mehreren Folgen).
    </div>
    ...
    <!--scheu-->
    <div id="scheu" class="pt-16 pb-4 text-center text-2xl">Josef Scheu</div>
