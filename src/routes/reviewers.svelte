<div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
  <div class="max-w-7xl mx-auto text-gray-600">
    ...
    <br />
    <div id="ambros" class="py-4 text-center text-2xl">August Wilhelm Ambros</div>
    ...
    <br />
    <!--bruyck-->
    <div id="bruyck" class="py-4 text-center text-2xl">Carl Debrois van Bruyck</div>
    ...
    <!--frey-->
    <div id="frey" class="py-4 text-center text-2xl">Wilhelm Frey</div>
    <div class="py-2">*14.03.1828 Brünn, †02.08.1902 Waidhofen an der Ybbs/NÖ</div>
    <div>
      <div class="float-left p-2 flex-1 flex-col">
    ...
    <!--gaigg-->
    <div id="gaigg" class="py-4 text-center text-2xl">Fritz Gaigg von Bergheim</div>
    ...
    <!--gollerich-->
    <div id="gollerich" class="py-4 text-center text-2xl">August Göllerich</div>
    ...
    <!--hirschfeld-->
    <div id="hirschfeld" class="py-4 text-center text-2xl">Robert Hirschfeld</div>
    ...
    <!--horn-->
    <div id="horn" class="py-4 text-center text-2xl">Camillo Horn</div>
